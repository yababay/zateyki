<script>
    ...
    import vsadnik from './mednii-vsadnik-benua.jpeg'

    const title = 'Ирония судьбы и классовой борьбы'
    const description = 'Тайные смыслы новогодней комедии'
    const vsadnikCaption = 'Александр Николаевич Бенуа. Вариант фронтисписа к поэме А. С. Пушкина «Медный всадник».'
</script>
...
<Figure caption={vsadnikCaption}>
    <img src={vsadnik} alt={vsadnikCaption}>
</Figure>
