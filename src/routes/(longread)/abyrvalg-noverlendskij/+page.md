...
<script>
    ...
    import src from './lyzlov.webp'
    export let data
    const { title, description, banner, image } = data
    const caption = 'Из книги Андрея Лызлова.'
</script>
...
восприятие текстов. О том, что имена эти явно
синтетические, свидетельствует и тот факт, что в народе они не прижились: никто никогда
...
впечатление. В пору моего детства бытовал образчик устного творчества, в
котором выражено пренебрежительное недоумение по поводу средневековой
тарабарщины:

> Английский король<br>
> Х…ло Второй<br>
> Выдал свою дочь Дину Б…дину<br>
...
деяний, легализации. Он прекрасно понимает, что современники
...
возникали сомнения, «доверять специалистам». Мало у кого была
...
студент, задумавшийся на лекции над нестыковкой в исторических фактах, мысленно
...
Те, кто придумывали это имя, максимально постарались, чтобы
...
Казалось бы, вполне нейтральный текст, не
...
могущественному покровителю. Так еще со времен Витрувия повелось, если не раньше».
...
[Публикация в Telegraph](https://telegra.ph/Abyrvalg-Noverlendskij-12-11)
