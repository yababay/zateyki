...
<script>
    ...
    import src   from './neroni.webp'
    export let data
    const { title, description, banner, image } = data
    const caption = 'Диотисальви Нерони не обнаружен.'
</script>
...
Недавно в «Анналах» Тацита прочитал следующее:
...
недостоверности текста. Во-вторых, здесь встречается удивительно ровное
...
Ух ты, как бы не захлебнуться в этом изобилии информации… По
...
1. в самую подозрительную с точки зрения вероятности фальсифицирования
       истории эпоху в Италии жил влиятельный человек с громкой фамилией Нерони, почти
...
[Публикация в Telegraph](https://telegra.ph/U-imperatora-Nerona-v-gostinoj-zhili-dva-barona-09-09)
