...
<script>
    ...
    import src from './ryc-01.webp'
    import src01 from './ryc-02.webp'
    import src02 from './scutum.webp'    
    export let data
    const { title, description, banner, image } = data
    const caption = 'Древнеримский шлем с наушниками.'
    const caption01 = '«Шапка земли греческой».'
    const caption02 = 'Римский щит скурум III в. н. э.'
</script>
...
благосклонно. Пишу я это отнюдь не для того, чтобы реабилитировать их. 
Они в этом не нуждаются. Цель данной работы — проследить
...
всадники, очевидна: шел активный процесс колонизации Центральной
...
раньше обосновавшихся финно-угров. Последние не горели желанием
...
плантации, не позволяют себя эксплуатировать.

Чем приучать к регулярному труду «непокорных зусулов», не проще ли
...
целенаправленно взращенного? Ведь рабовладельческие
...
Бертолуччи, «Укрощение строптивого» и др.

При попытках колонизировать «ничьи» земли, как правило выясняется, что
там уже живут, какие-то поганцы (от античного pag — часть племени или 
тюркского bagan — идол). Но
...
первое время. Ну, а чтобы «какое-то басурманское племя» не вздумало
...
казаков представления о рыцарстве свои, особенные («И погиб козак! Пропал для всего козацкого
рыцарства!»), а у поляков свои, но в обоих случаях это не романтическая
...
приведу цитату из оперы Мусоргского «Хованщина»: «Отцы и братья! Мне
...
«Хованщина» не ахти какой
источник, но другие найти при желании не трудно. Например, в [книге
о графине Головкиной](https://yababay.website.yandexcloud.net/i-isportila-emu-vsu-ssylku/), описывающей события 1740-х гг., «рейтары»
сопровождают опальных дворян аж до Колымы.
...
Тит Ливий пишет: «Несомненно, они же &lang;венеты&rang; положили начало
...
германских государствах именуют всевозможные парламенты (советы, напр.,
...
подразделения (с добавлением слова `equitata`, например, `Cohors VII Raetorum equitata`). Заметим, что родственниками и непосредственными
...
письменном виде зафиксировать за многие столетия до изобретения бумаги. 
Кто-нибудь пробовал выучить наизусть
...
времени не было ни одного знаменитого князя? Но ведь написано Троян, а не
Траян, значит это, конечно же, разные лица.
...
земли греческой, И ляпнулъ онъ въ идолище поганое». («Ах вы вот как? Драться каской?
Ну не подлый ли народ?!», — описывал аналогичный случай А. Твардовский).
Шапка земли
...
Ну, и о щитах пару слов следует сказать. На иконах и лаковых миниатюрах
воинство князя Игоря и современных ему богатырей изображают с заостренными
книзу низами. По-моему, они только на картинке хорошо смотрятся,
в изготовлении же и в применении проигрывают древнеримскому прямоугольному:
...
> Клектом орлы на кости зверей зовут,<br>
> Лисицы брешут на червленые щиты…
>
> Русские поле великое червлеными щитами прегородили,<br>
> Ища себе чести, а князю славы.

О красных прямоугольных древнеримских
или о лубочных с заостренными низами, которых так и не найдено археологами 
и которыми «поле великое» перегородить не получится, потому что
в районе ног будут уязвимые, открытые места?
...
та самая Ретия. Из нее римская военная культура и стала, видимо,
...
[Публикация в Telegraph](https://telegra.ph/Russkie-i-rycari-05-19)
