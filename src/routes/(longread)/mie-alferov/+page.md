...
> Второе массовое применение &lang;холодных лазеров&rang; — компактдиски. В конце семидесятых компании Philips и Sony разработали оптический диск для записи звука.
>
