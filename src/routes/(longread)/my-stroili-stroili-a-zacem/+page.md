...
<script>
    ...
    import src03 from './stena.webp'
    export let data
    const { title, description, banner, image } = data
    const caption   = 'Германский замок Эльц.'
    const caption01 = 'Спасо-Преображенский монастырь.'
    const caption02 = 'Знаменская башня в Ярославле.'
...
Одним из главных его архитектурных памятников считается
...
построена просто так, для удовлетворения феодального тщеславия.

[Публикация в Telegraph](https://telegra.ph/My-stroili-stroili-A-zachem-09-12)
