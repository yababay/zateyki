...
<script>
    ...
    import src   from './venedy-01.webp'
    import src01 from './venedy-02.webp'
    export let data
    const { title, description, banner, image } = data
    const caption = 'Вендская держава.'
    const caption01 = 'Венеды на берегах Балтики и Атлантики.'
</script>
...
отношения и говорили на сходных языках. Не без натяжки, но к
винделикам можно присовокупить вандалов, в которых то же слово скрывается 
с помощью подмены гласных.
...
в кораблестроении на голову. Об этом свидетельствует не кто-нибудь, а
...
XVIII в. Голштейн-Готторпы воцарились на финских берегах и вовсе в
...
вопрос не прозвучало. Одни намеки, догадки,
...
между прочим, при написании «Истории Государства Российского» Н. М. Карамзин. 
Вот что там сказано:
...
[Публикация в Telegraph](https://telegra.ph/Vendy-venedy-venety-Venecii-11-15)
