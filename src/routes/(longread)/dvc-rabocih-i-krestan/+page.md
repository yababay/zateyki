...
<script>
    ...
    import src    from './dvc-01.webp'
    import src01  from './dvc-02.webp'
    import src02  from './dvc.gif'
    import src03  from './dvc-03.webp'
    export let data
    const { title, description, banner, image } = data
    const caption = 'Лепнина, выполненная крестьянами-отходниками.'
    const caption01 = 'Формула, доступная пониманию учащихся советских техникумов.'
    const caption02 = 'Чертеж редуктора — задание для техникумовской курсовой работы.'
    const caption03 = 'Группа каслинских мастеров, создавших чугунный павильон для Всемирной выставки.'
</script>

<Helper {title} {description} {banner} {image} />

В стане российских альтернативщиков летом 2021 г. случился скандал. «Исторический вольнодумец» Михаил
посетил Египет для ознакомления с древними сооружениями. С
...
обеспеченными (в смысле накормленными и имеющими крышу над головой), сплоченными и
...
техникой, я решил изложить несколько личных впечатлений.
...
я учился в Ярославском автомеханическом техникуме, где преподавалось много довольно
...
Только делать это приходилось без использования программы `AutoCAD` (на рисунке явно 
сгенерированное на компьютере изображение), ее
тогда не было и в проекте. Чертеж нужно было выполнить примерно такого же качества, но
вручную с помощью таких инструментов как карандаши различной твердости,
рейсшина, угольник, транспортир, готовальня (набор циркулей), кульман, ватман и рейсфедер. 

Думаю, наш тогдашний техникум по качеству знаний мог бы дать фору иному
нынешнему политеху, но здесь речь о возможностях ручного труда, к
...
Задача заключалась в том, чтобы обработать одну из
...
пирамиды — простые нагромождения камней? Но сможет ли кто-нибудь
...
На фото группа каслинских мастеров, создавших ажурный чугунный павильон для
Всемирной выставки в Париже в 1900 году, получивший Гран-при и
признанный ЮНЕСКО в 1978 г. мировым шедевром.

[Публикация в Telegraph](https://telegra.ph/DVC-rabochih-i-krestyan-06-07)
