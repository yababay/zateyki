...
<script>
    ...
    import src from './domik-pp.webp'
    import src01 from './kanonerka.webp'
    export let data
    const { title, description, banner, image } = data
    const caption = 'Домик Петра Первого.'
    const caption01 = 'Канонерская лодка с пушкой.'
</script>
...
Показателен в этом смысле рассказ М. Е. Салтыкова-Щедрина «Дикий
...
практически принудительно (это одна из целей реформы Александра II).
...
> Плохо человеку, когда он один.<br>
> Горе одному, один не воин — <br>
> Каждый дюжий ему господин,<br>
...
[Публикация в Telegraph](https://telegra.ph/Krepostnye-iz-krepostej-i-zhuki-bombardiry-01-01)
