...
description: Грязные приемведения научной дискуссии в ленинской работе «Материализм и эмпириокритицизм».
---
<script>
...
«&lang;Богданов&rang; **брал от немецких профессоров на веру** то, что они называли «современным позитивизмом».
