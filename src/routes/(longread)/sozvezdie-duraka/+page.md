...
Интересно, что в реальной практике при чтении этого текста добавляется «Господи, помилуй! &lang;трижды&rang; Слава Отцу и Сыну и Святому духу!» Здесь число три (число звезд в поясе Ориона) используется дважды, чтобы каждый участник процессии обратил внимание на этот ориентир. 
